...
class HashMap:
    ...
    def __init__(self, capacity: int = 7, hash_function=default_hash_function, load_factor_threshold: float = default_load_factor_threshold) -> None:
        ...
        self._load_factor_thresh=load_factor_threshold
        self._count=0
    ...
    def __getitem__(self, key: Any) -> Any:
        ...
        if key not in self._keys:
            raise KeyError
        key_hash=self._hash(key,self._capacity)
    ...
    def resize_and_rehash(self, new_table_size: int, new_hash_function) -> None:
        """ Resize the hash map to a new table size and rehash the items.
            ...
            Returns:
                None
            """
        new_values=Array(new_table_size)
        self._hash=new_hash_function
        for i in self._keys:
            new_values[self._hash(i,new_table_size)]=self._values[self._hash(i,self.capacity)]
